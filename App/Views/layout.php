...
<head>
    ...
    <title><?= $title ?? 'Donor Management' ?> - Beneficiary System</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="/">Beneficiary & Donor Management</a>
    ...
    <footer class="bg-light text-center py-4 mt-5">
        <p class="text-muted">&copy; 2024 Donor & Beneficiary Management System</p>
    </footer>
